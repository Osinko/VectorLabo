...
public class Line2LineCheck : MonoBehaviour
{
	...
	public bool CheckLine2Line ( Vector3 vStart , Vector3 vEnd , Vector3 wStart , Vector3 wEnd )
	{
		...
		crossNormalCheck = 0 == (Vector3.Cross (cross_vw, cross_common)).sqrMagnitude;
		crossDotCheck = 0 > Vector3.Dot (cross_vw, cross_common);	//これひくりがえると駄目かも　!=　がいい？？
